...
reported privately to the project maintainers. If you are not comfortable
using a public channel, open a confidential report through the repository's
**Security** tab ("Report a vulnerability" also routes privately to the
maintainers).
